		...
		<div>
			<div className="antialiased bg-white w-full min-h-screen text-slate-900 relative py-4">
				<div className="grid grid-cols-12 mx-auto gap-1 sm:gap-3 md:gap-4 lg:gap-7 xl:gap-10 max-w-7xl my-10 px-2">
					<div
						id="menu"
						className=" bg-resq-500 col-span-3 rounded-lg p-4 "
					>
						<h1
            ...
            <div onClick={() => auth.signOut()} style={{cursor:"pointer"}} className="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">
                  ...
                  color="white"
					...
					<div
						id="content"
						className="bg-resq-100 col-span-6 rounded-lg p-6"
					>
						<div id="24h">
					...
					<div
						id="menu"
						className="bg-white/10 col-span-3 rounded-lg p-4 "
					>
						<div id="menu" className="flex flex-col space-y-2 my-5">
