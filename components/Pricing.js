          ...
          <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-12 py-8 lg:py-12 px-6 sm:px-0 lg:px-6">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black flex-grow">
                  <li className="relative check custom-list my-2">
                    We make an ecosystem where government authorites , Ngo and
                    needy one's hence help will provided as soon as possible.
                  </li>
                </ul>
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black flex-grow">
                  <li className="relative check custom-list my-2">
                    Disasters or Help seeking Tweets Classification
                  </li>
                  <li className="relative check custom-list my-2">
                    Smart AI Powered Bot
                  </li>
                </ul>
                <div className="flex flex-col w-full justify-center mb-8 flex-none mt-5">
                  <ButtonOutline>Explore</ButtonOutline>
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black flex-grow">
                  <li className="relative check custom-list my-2">
                    Broadcast room {"(Broadcast generated by Authorities)"}
                  </li>
                  <li className="relative check custom-list my-2">
                    Previous Disaster Info's
                  </li>
                  <li className="relative check custom-list my-2">
                    Help / Emergency requests triggeres
                  </li>
                </ul>
                <div className="flex flex-col w-full justify-center mb-8 flex-none mt-5">
                  <ButtonOutline>Explore</ButtonOutline>
